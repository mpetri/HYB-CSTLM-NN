...
Finally, the discount $D$ on line 12 and $\nlplus{\Bigcdot\Bigcdot}$ can be precomputed directly from the \CSTs reusing several of the algorithms, to avoid further costly runtime computations. 
Please see Algorithm~5 in the \supp for details. \trevor{Provide time complexity?}
