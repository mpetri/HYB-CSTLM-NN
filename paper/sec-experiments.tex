...
\end{table}
Figure~\ref{fig:germanpattern} is showing XXX.
...
Figure~\ref{fig:space-time} shows the time and memory usage during training and querying with \SRILM default (optimized for time), and compact (optimized for space). 
