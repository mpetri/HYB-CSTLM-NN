...
\caption{All 9 languages pplx results with m=2..10,15,20,infinity.}
\end{figure}

\begin{figure}
\includegraphics[width=\columnwidth]{figures/Time-Space.pdf}
\caption{On German, showing the size in MB (y axis) and time (x axis) for 4 methods: CST single, CST dual, SRILM, SRILM compact. Each method is a 'line' connecting m=2,3,4,... Only CST single will go beyond m=6.}
\end{figure}
