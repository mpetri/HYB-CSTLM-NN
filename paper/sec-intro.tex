...
raising challenges of efficient storage and retrieval.
...
In contrast, we make use of recent advances in  \emph{compressed suffix trees} (\CSTs) \cite{s-tcs07} 
...
a wavelet tree based FM-index \cite{fmmn-talg07}, which results in better time
complexity and considerably faster runtime performance.
...
Overall this paper illustrates the vast potential succinct indexes have for language modelling  and
