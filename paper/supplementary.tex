...
Language&&Size (MB)&Tokens (M)& Word Types& Sentences (K)\\
\toprule
...
\end{tabular}}
\caption{Europarl dataset statistics, where tokens, types and sentence counts refer to the training partition. }\label{fig:data}
\end{table}
