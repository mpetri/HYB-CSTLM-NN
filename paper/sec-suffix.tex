...
size {\alphabetsize}. Let {$\col[i..\collen-1]$} be a {\it suffix} of {\col} \ehsan{Do we use this anywhere in the write-up?}.
...
values are periodically sampled using a given sample rate \SASAMPLE (e.g. 32) \ehsan{1-2 sentences about SAS is required.}. Then, 
