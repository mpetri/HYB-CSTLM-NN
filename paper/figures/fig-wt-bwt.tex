...
\node[internal,text width=6.5cm] (root) at (5*\xscale,\lvlzero*\yscale) {
\setlength\tabcolsep{0.5pt}
\begin{tabular}{cccccccccccccccccccccccc}
{\tt \#} & {\tt n} & {\tt T} &{\tt \$} &{\tt p} &{\tt p} &{\tt t} &{\tt t} &{\tt n} &{\tt n} 
&{\tt r} &{\tt r} &{\tt t} &{\tt t} &{\tt o} &{\tt t} &{\tt s} &{\tt s}&{\tt i}
&{\tt \#}&{\tt \#}&{\tt i}&{\tt t} \\
{\tt 0} & {\tt 1} & {\tt 1} &{\tt 0} &{\tt 0} &{\tt 0} &{\tt 1} &{\tt 1} &{\tt 1} &{\tt 1} 
&{\tt 0} &{\tt 0} &{\tt 1} &{\tt 1} &{\tt 1} &{\tt 1} &{\tt 1} &{\tt 1} &{\tt 1}&{\tt 0}
&{\tt 0}&{\tt 0}&{\tt 0}&{\tt 1} \\
\end{tabular}
};
...
{\tt 0} & {\tt 1} &{\tt 1} &{\tt 1} &{\tt 0} &{\tt 0} &{\tt 1} &{\tt 1} &{\tt 0} &{\tt 1} &{\tt 0} &{\tt 0}&{\tt 1} \\
\end{tabular}
};
...
\draw (l-hash.north) -- (n-hashdollar);
\draw (l-dollar.north) -- (n-hashdollar);

\draw (l-i.north) -- (n-hashidollar);
\draw (l-o.north) -- (n-nso);

\draw (n-hashdollar.north) -- (n-hashidollar);

\draw (n-ns.north) -- (n-nso);

\draw (n-nso.north) -- (n-ntTos);
\draw (n-tT.north) -- (n-ntTos);
\draw (n-pr.north) -- (n-hdppri);
\draw (n-hashidollar.north) -- (n-hdppri);

\draw (n-hdppri.north) -- (root);
\draw (n-ntTos.north) -- (root);
